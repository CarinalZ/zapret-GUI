...
**Важно:** программа распространяется только в виде исходного кода (`.py`), так как скомпилированный `.exe` весит около 35 МБ и превышает лимит GitHub в 25 МБ для файлов.
